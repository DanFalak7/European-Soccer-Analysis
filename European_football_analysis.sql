...
SELECT *
FROM matches
WHERE country_id IN(1729, 4769, 7809, 10257, 21518)); -- EPL, Ligue 1, Bundesliga, Serie A and Laliga


-- Question: How many matches were played in each league, how many total goals were scored, and what is the average number of goals per match?
...
-- Question: Which European leagues are the most competitive based on match outcomes?
...
-- Question: Which teams have been historically dominant across all seasons in each league?
...
-- Question: Which teams are the most dominant across all leagues based on win rate?
...
-- Question: Which teams are the least efficient at winning matches?
...
-- Question: How strong is home advantage across different leagues?
...
-- Question: Which teams benefit the most from playing at home?
...
-- Question: Which seasons were unusually high or low scoring compared to league averages?
...
-- Question: Which match stages (weeks) are the most competitive in each league?
...
-- Question:Which part of the season is generally more competitive?
...
-- Question: Which month has historically produced the highest number of goals in each league?
